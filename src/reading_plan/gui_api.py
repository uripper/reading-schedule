...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--settings", default="data/settings.json", help="Settings JSON path for --sample")
    return p.parse_args()
...
def main() -> int:
    ...
    try:
        if args.sample:
            ...
            data = {"books": [book_to_data(b) for b in books], "settings": settings_to_data(settings)}
